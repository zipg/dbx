...
export default withEnglishFallback({
  ...
  settings: {
    ...
    webviewDiagnosticsTitle: "Diagnóstico do WebView",
    webviewDiagnosticsDescription: "Use para investigar no Windows quando a janela principal não abre e apenas o ícone da bandeja fica visível.",
    webviewDiagnosticsRefresh: "Atualizar",
    webviewDiagnosticsLoading: "Carregando",
    webviewDiagnosticsFailed: "Falha ao carregar",
    webviewVersion: "Versão atual do WebView",
    webviewVersionUnknown: "Desconhecida",
    webviewPlatform: "Plataforma",
    webviewRegistry: "Registro do WebView2 Runtime",
    webviewRegistryMissing: "Nenhuma entrada de registro do WebView2 Runtime detectada",
