...
export default withEnglishFallback({
  ...
  settings: {
    ...
    webviewDiagnosticsTitle: "WebView診断",
    webviewDiagnosticsDescription: "Windowsでメインウィンドウが開かず、トレイアイコンだけが表示される問題の調査に使用します。",
    webviewDiagnosticsRefresh: "更新",
    webviewDiagnosticsLoading: "読み込み中",
    webviewDiagnosticsFailed: "読み込み失敗",
    webviewVersion: "現在のWebViewバージョン",
    webviewVersionUnknown: "不明",
    webviewPlatform: "プラットフォーム",
    webviewRegistry: "WebView2 Runtimeレジストリ",
    webviewRegistryMissing: "WebView2 Runtimeのレジストリ項目が見つかりません",
