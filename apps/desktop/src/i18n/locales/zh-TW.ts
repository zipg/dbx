...
export default withEnglishFallback({
  ...
  settings: {
    ...
    debugLogsClear: "清空日誌",
    webviewDiagnosticsTitle: "WebView 診斷",
    webviewDiagnosticsDescription: "用於排查 Windows 主視窗無法開啟、只顯示系統匣圖示等問題。",
    webviewDiagnosticsRefresh: "重新整理",
    webviewDiagnosticsLoading: "讀取中",
    webviewDiagnosticsFailed: "讀取失敗",
    webviewVersion: "目前 WebView 版本",
    webviewVersionUnknown: "未知",
    webviewPlatform: "平台",
    webviewRegistry: "WebView2 Runtime 登錄檔",
    webviewRegistryMissing: "未偵測到 WebView2 Runtime 登錄檔項目",
