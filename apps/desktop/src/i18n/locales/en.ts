export default {
  ...
  settings: {
    ...
    webviewDiagnosticsTitle: "WebView diagnostics",
    webviewDiagnosticsDescription: "Use this when troubleshooting a Windows main window that does not open and only leaves the tray icon visible.",
    webviewDiagnosticsRefresh: "Refresh",
    webviewDiagnosticsLoading: "Loading",
    webviewDiagnosticsFailed: "Failed to load",
    webviewVersion: "Current WebView version",
    webviewVersionUnknown: "Unknown",
    webviewPlatform: "Platform",
    webviewRegistry: "WebView2 Runtime registry",
    webviewRegistryMissing: "No WebView2 Runtime registry entry detected",
