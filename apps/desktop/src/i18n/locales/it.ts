...
export default withEnglishFallback({
  ...
  settings: {
    ...
    webviewDiagnosticsTitle: "Diagnostica WebView",
    webviewDiagnosticsDescription: "Usalo per analizzare su Windows quando la finestra principale non si apre e resta visibile solo l'icona nella barra.",
    webviewDiagnosticsRefresh: "Aggiorna",
    webviewDiagnosticsLoading: "Caricamento",
    webviewDiagnosticsFailed: "Caricamento non riuscito",
    webviewVersion: "Versione WebView corrente",
    webviewVersionUnknown: "Sconosciuta",
    webviewPlatform: "Piattaforma",
    webviewRegistry: "Registro WebView2 Runtime",
    webviewRegistryMissing: "Nessuna voce di registro WebView2 Runtime rilevata",
