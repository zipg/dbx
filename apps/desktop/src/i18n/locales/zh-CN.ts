...
export default withEnglishFallback({
  ...
  settings: {
    ...
    debugLogsClear: "清空日志",
    webviewDiagnosticsTitle: "WebView 诊断",
    webviewDiagnosticsDescription: "用于排查 Windows 主窗口无法打开、只显示托盘图标等问题。",
    webviewDiagnosticsRefresh: "刷新",
    webviewDiagnosticsLoading: "读取中",
    webviewDiagnosticsFailed: "读取失败",
    webviewVersion: "当前 WebView 版本",
    webviewVersionUnknown: "未知",
    webviewPlatform: "平台",
    webviewRegistry: "WebView2 Runtime 注册表",
    webviewRegistryMissing: "未检测到 WebView2 Runtime 注册表项",
