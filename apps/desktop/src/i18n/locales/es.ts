...
export default withEnglishFallback({
  ...
  settings: {
    ...
    webviewDiagnosticsTitle: "Diagnóstico de WebView",
    webviewDiagnosticsDescription: "Úsalo para investigar en Windows cuando la ventana principal no se abre y solo queda visible el icono de la bandeja.",
    webviewDiagnosticsRefresh: "Actualizar",
    webviewDiagnosticsLoading: "Cargando",
    webviewDiagnosticsFailed: "No se pudo cargar",
    webviewVersion: "Versión actual de WebView",
    webviewVersionUnknown: "Desconocido",
    webviewPlatform: "Plataforma",
    webviewRegistry: "Registro de WebView2 Runtime",
    webviewRegistryMissing: "No se detectó ninguna entrada de registro de WebView2 Runtime",
    webviewUserAgent: "User Agent",
